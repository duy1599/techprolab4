...
namespace ContosoSite.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,LastName,FirstName,Birthday,ProgramID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,LastName,FirstName,Birthday,ProgramID")] Student student)
        {
            if (ModelState.IsValid)
            {
